				...
				<div class="my-auto pb-10 w-full max-w-md mx-auto">
					{#if ($config?.features.auth_trusted_header ?? false) || $config?.features.auth === false}
						<div class="my-auto pb-10 w-full">
							<div
								class="flex items-center justify-center gap-3 text-xl sm:text-2xl text-center font-semibold text-gray-900"
							>
								<div>
						...
						<div class="text-gray-900">
									...
									{#if $config?.features.enable_login_form || $config?.features.enable_ldap}
										...
										{:else}
											...
											<div class=" mt-4 text-sm text-center">
												...
												<a href="/register" class=" font-medium underline">
							...
							{#if Object.keys($config?.oauth?.providers ?? {}).length > 0}
								<div class="inline-flex items-center justify-center w-full">
									...
									{#if $config?.features.enable_login_form || $config?.features.enable_ldap}
										<span class="px-3 text-sm font-medium text-gray-900 bg-transparent"
											>{$i18n.t('or')}</span
										>
									{/if}
